...
export const ProjectContainer = ({ className, ...rest }: any) => (
  <article className={classes(styles.project, className)} {...rest} />
);
export const ProjectSection = forwardRef<any>(
  (
    {
      className,
      light,
...
export const ProjectImage = ({ className, alt, ...rest }: any) => (
...
export const ProjectSectionText = ({ className, ...rest }: any) => (
  <Text
